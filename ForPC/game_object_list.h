...
// std::vector slow for my project. game_object_list capacity limited by world_size
...
public:
	...
	const game_type& size() const { return pointer; };
	const bool is_full() const { return pointer == world_size - 1; }
